...
export const listMyConsumerProducts = () => async (dispatch, getState) => {
    try {
        dispatch({ type: CONSUMER_PRODUCT_LIST_REQUEST })
...
// FIXED: Now properly sends productData to the backend
export const createConsumer = (productData) => async (dispatch, getState) => {
    try {
