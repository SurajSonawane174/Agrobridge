...
import {
    getConsumerProducts,
    getMyConsumerProducts,  // ADD THIS IMPORT
    getConsumerProductById,
    deleteConsumerProduct,
    createConsumer,
    updateConsumer,
    createConsumerProductReview  // ADD THIS IMPORT
...
router
    .route('/consumer/myproducts')
    .get(protect, getMyConsumerProducts)
